...
module equalizer_equalizer_Pipeline_cpe_est (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        lts_pilot_M_real_V_0_013_reload,
        lts_pilot_M_real_V_1_014_reload,
        lts_pilot_M_real_V_2_015_reload,
        lts_pilot_M_real_V_3_016_reload,
        lts_pilot_M_imag_V_0_017_reload,
        lts_pilot_M_imag_V_1_018_reload,
        lts_pilot_M_imag_V_2_019_reload,
        lts_pilot_M_imag_V_3_020_reload,
        in_i_V_out,
        in_i_V_out_ap_vld,
        in_q_V_out,
        in_q_V_out_ap_vld
...
input  [15:0] lts_pilot_M_real_V_0_013_reload;
input  [15:0] lts_pilot_M_real_V_1_014_reload;
input  [15:0] lts_pilot_M_real_V_2_015_reload;
input  [15:0] lts_pilot_M_real_V_3_016_reload;
input  [15:0] lts_pilot_M_imag_V_0_017_reload;
input  [15:0] lts_pilot_M_imag_V_1_018_reload;
input  [15:0] lts_pilot_M_imag_V_2_019_reload;
input  [15:0] lts_pilot_M_imag_V_3_020_reload;
output  [31:0] in_i_V_out;
output   in_i_V_out_ap_vld;
output  [31:0] in_q_V_out;
output   in_q_V_out_ap_vld;

reg ap_idle;
reg symbol_iq_M_real_V_ce0;
reg symbol_iq_M_imag_V_ce0;
reg in_i_V_out_ap_vld;
reg in_q_V_out_ap_vld;
...
wire   [0:0] tmp_5_fu_270_p6;
reg   [0:0] tmp_5_reg_538;
wire  signed [31:0] sext_ln225_fu_309_p1;
wire  signed [31:0] sext_ln225_8_fu_313_p1;
reg  signed [31:0] sext_ln225_8_reg_554;
wire  signed [31:0] sext_ln225_10_fu_317_p1;
reg  signed [31:0] sext_ln225_10_reg_560;
wire  signed [31:0] sext_ln225_9_fu_334_p1;
wire  signed [31:0] grp_fu_399_p2;
wire    ap_block_pp0_stage0;
reg   [31:0] in_q_V_fu_88;
wire   [31:0] add_ln870_3_fu_375_p2;
wire    ap_loop_init;
reg   [31:0] in_i_V_fu_92;
wire   [31:0] add_ln870_2_fu_369_p2;
reg   [2:0] i_V_3_fu_96;
reg   [2:0] ap_sig_allocacmp_i_V;
wire   [2:0] add_ln870_fu_236_p2;
wire    ap_block_pp0_stage0_01001;
wire   [1:0] tmp_6_fu_246_p5;
wire   [5:0] tmp_6_fu_246_p6;
wire   [15:0] input_i_V_3_fu_279_p2;
wire   [15:0] input_i_V_5_fu_284_p3;
wire  signed [15:0] rhs_fu_291_p6;
wire  signed [15:0] rhs_1_fu_300_p6;
...
mux_42_6_1_1_U14(
    ...
    .din2(6'd43),
    .din3(6'd57),
    .din4(tmp_6_fu_246_p5),
    .dout(tmp_6_fu_246_p6)
);
...
equalizer_mux_42_16_1_1 #(
    ...
    .dout_WIDTH( 16 ))
mux_42_16_1_1_U16(
    .din0(lts_pilot_M_real_V_0_013_reload),
    .din1(lts_pilot_M_real_V_1_014_reload),
    .din2(lts_pilot_M_real_V_2_015_reload),
    .din3(lts_pilot_M_real_V_3_016_reload),
    .din4(trunc_ln1049_reg_515_pp0_iter1_reg),
    .dout(rhs_fu_291_p6)
);
...
equalizer_mux_42_16_1_1 #(
    ...
    .dout_WIDTH( 16 ))
mux_42_16_1_1_U17(
    .din0(lts_pilot_M_imag_V_0_017_reload),
    .din1(lts_pilot_M_imag_V_1_018_reload),
    .din2(lts_pilot_M_imag_V_2_019_reload),
    .din3(lts_pilot_M_imag_V_3_020_reload),
    .din4(trunc_ln1049_reg_515_pp0_iter1_reg),
    .dout(rhs_1_fu_300_p6)
);
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln1057_fu_230_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_V_3_fu_96 <= add_ln870_fu_236_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ...
            in_i_V_fu_92 <= add_ln870_2_fu_369_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            ...
            in_q_V_fu_88 <= add_ln870_3_fu_375_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        input_i_V_reg_532 <= symbol_iq_M_real_V_q0;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        sext_ln225_10_reg_560 <= sext_ln225_10_fu_317_p1;
        sext_ln225_8_reg_554 <= sext_ln225_8_fu_313_p1;
        tmp_5_reg_538 <= tmp_5_fu_270_p6;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_i_V = i_V_3_fu_96;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln1057_reg_511_pp0_iter4_reg == 1'd1))) begin
        in_i_V_out_ap_vld = 1'b1;
    end else begin
        in_i_V_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln1057_reg_511_pp0_iter4_reg == 1'd1))) begin
        in_q_V_out_ap_vld = 1'b1;
    end else begin
        in_q_V_out_ap_vld = 1'b0;
    end
end
...
assign add_ln870_2_fu_369_p2 = ($signed(sext_ln1676_fu_356_p1) + $signed(in_i_V_fu_92));

assign add_ln870_3_fu_375_p2 = (out_q_V_fu_360_p4 + in_q_V_fu_88);

assign add_ln870_fu_236_p2 = (ap_sig_allocacmp_i_V + 3'd1);
...
assign grp_fu_412_p0 = sext_ln225_10_reg_560;

assign grp_fu_412_p1 = sext_ln225_9_fu_334_p1;

assign grp_fu_420_p0 = sext_ln225_8_reg_554;

assign grp_fu_420_p1 = sext_ln225_9_fu_334_p1;

assign icmp_ln1057_fu_230_p2 = ((ap_sig_allocacmp_i_V == 3'd4) ? 1'b1 : 1'b0);

assign in_i_V_out = in_i_V_fu_92;

assign in_q_V_out = in_q_V_fu_88;

assign input_i_V_3_fu_279_p2 = (16'd0 - input_i_V_reg_532);

assign input_i_V_5_fu_284_p3 = ((tmp_5_fu_270_p6[0:0] == 1'b1) ? input_i_V_3_fu_279_p2 : input_i_V_reg_532);

assign input_q_V_6_fu_327_p3 = ((tmp_5_reg_538[0:0] == 1'b1) ? symbol_iq_M_imag_V_q0 : input_q_V_fu_321_p2);

assign input_q_V_fu_321_p2 = (16'd0 - symbol_iq_M_imag_V_q0);
...
assign sext_ln225_10_fu_317_p1 = rhs_1_fu_300_p6;

assign sext_ln225_8_fu_313_p1 = rhs_fu_291_p6;

assign sext_ln225_9_fu_334_p1 = $signed(input_q_V_6_fu_327_p3);

assign sext_ln225_fu_309_p1 = $signed(input_i_V_5_fu_284_p3);

assign symbol_iq_M_imag_V_address0 = zext_ln573_reg_522_pp0_iter1_reg;

assign symbol_iq_M_real_V_address0 = zext_ln573_fu_260_p1;

assign tmp_6_fu_246_p5 = ap_sig_allocacmp_i_V[1:0];

assign trunc_ln1049_fu_242_p1 = ap_sig_allocacmp_i_V[1:0];

assign zext_ln573_fu_260_p1 = tmp_6_fu_246_p6;
...
endmodule //equalizer_equalizer_Pipeline_cpe_est
